...
namespace Daftari.SMSHandling.TamimahSMS {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://www.tamimahsms.com/", ConfigurationName="TamimahSMS.BulkPushSoap")]
    public interface BulkPushSoap {
        ...
        Daftari.SMSHandling.TamimahSMS.SendSMSResponse SendSMS(Daftari.SMSHandling.TamimahSMS.SendSMSRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="https://www.tamimahsms.com/SendSMS", ReplyAction="*")]
        System.Threading.Tasks.Task<Daftari.SMSHandling.TamimahSMS.SendSMSResponse> SendSMSAsync(Daftari.SMSHandling.TamimahSMS.SendSMSRequest request);
    }
    ...
    public partial class SendSMSRequest {
        ...
        public Daftari.SMSHandling.TamimahSMS.SendSMSRequestBody Body;
        
        public SendSMSRequest() {
        }
        
        public SendSMSRequest(Daftari.SMSHandling.TamimahSMS.SendSMSRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponse {
        ...
        public Daftari.SMSHandling.TamimahSMS.SendSMSResponseBody Body;
        
        public SendSMSResponse() {
        }
        
        public SendSMSResponse(Daftari.SMSHandling.TamimahSMS.SendSMSResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class SendSMSResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public Daftari.SMSHandling.TamimahSMS.SendStatus SendSMSResult;
        
        public SendSMSResponseBody() {
        }
        
        public SendSMSResponseBody(Daftari.SMSHandling.TamimahSMS.SendStatus SendSMSResult) {
            this.SendSMSResult = SendSMSResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface BulkPushSoapChannel : Daftari.SMSHandling.TamimahSMS.BulkPushSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BulkPushSoapClient : System.ServiceModel.ClientBase<Daftari.SMSHandling.TamimahSMS.BulkPushSoap>, Daftari.SMSHandling.TamimahSMS.BulkPushSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Daftari.SMSHandling.TamimahSMS.SendSMSResponse Daftari.SMSHandling.TamimahSMS.BulkPushSoap.SendSMS(Daftari.SMSHandling.TamimahSMS.SendSMSRequest request) {
            return base.Channel.SendSMS(request);
        }
        
        public Daftari.SMSHandling.TamimahSMS.SendStatus SendSMS(string UserName, string Password, string Message, long Priority, string Schdate, string Sender, string AppID, string SourceRef, string MSISDNs) {
            Daftari.SMSHandling.TamimahSMS.SendSMSRequest inValue = new Daftari.SMSHandling.TamimahSMS.SendSMSRequest();
            inValue.Body = new Daftari.SMSHandling.TamimahSMS.SendSMSRequestBody();
            ...
            Daftari.SMSHandling.TamimahSMS.SendSMSResponse retVal = ((Daftari.SMSHandling.TamimahSMS.BulkPushSoap)(this)).SendSMS(inValue);
            return retVal.Body.SendSMSResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Daftari.SMSHandling.TamimahSMS.SendSMSResponse> Daftari.SMSHandling.TamimahSMS.BulkPushSoap.SendSMSAsync(Daftari.SMSHandling.TamimahSMS.SendSMSRequest request) {
            return base.Channel.SendSMSAsync(request);
        }
        
        public System.Threading.Tasks.Task<Daftari.SMSHandling.TamimahSMS.SendSMSResponse> SendSMSAsync(string UserName, string Password, string Message, long Priority, string Schdate, string Sender, string AppID, string SourceRef, string MSISDNs) {
            Daftari.SMSHandling.TamimahSMS.SendSMSRequest inValue = new Daftari.SMSHandling.TamimahSMS.SendSMSRequest();
            inValue.Body = new Daftari.SMSHandling.TamimahSMS.SendSMSRequestBody();
            inValue.Body.UserName = UserName;
            inValue.Body.Password = Password;
            ...
            inValue.Body.SourceRef = SourceRef;
            inValue.Body.MSISDNs = MSISDNs;
            return ((Daftari.SMSHandling.TamimahSMS.BulkPushSoap)(this)).SendSMSAsync(inValue);
        }
    }
}
